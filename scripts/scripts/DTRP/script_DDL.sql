...
CREATE SEQUENCE DECLARACAO_TRANSPORTE_DESTINATARIO_RESIDUO_SEQ
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE DECLARACAO_TRANSPORTE_DESTINATARIO_RESIDUO_SEQ
  OWNER TO seia_sema;
GRANT ALL ON SEQUENCE DECLARACAO_TRANSPORTE_DESTINATARIO_RESIDUO_SEQ TO seia_sema;
GRANT SELECT ON SEQUENCE DECLARACAO_TRANSPORTE_DESTINATARIO_RESIDUO_SEQ TO consulta;

CREATE TABLE declaracao_transporte_destinatario_residuo
(
	ide_declaracao_transporte_destinatario_residuo INTEGER NOT NULL DEFAULT nextval(('DECLARACAO_TRANSPORTE_DESTINATARIO_RESIDUO_SEQ'::text)::regclass),
...
CREATE SEQUENCE DECLARACAO_TRANSPORTE_DISPOSICAO_FINAL_RESIDUO_SEQ
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE DECLARACAO_TRANSPORTE_DISPOSICAO_FINAL_RESIDUO_SEQ
  OWNER TO seia_sema;
GRANT ALL ON SEQUENCE DECLARACAO_TRANSPORTE_DISPOSICAO_FINAL_RESIDUO_SEQ TO seia_sema;
GRANT SELECT ON SEQUENCE DECLARACAO_TRANSPORTE_DISPOSICAO_FINAL_RESIDUO_SEQ TO consulta;

CREATE TABLE declaracao_transporte_disposicao_final_residuo
(
	ide_declaracao_transporte_disposicao_final_residuo INTEGER NOT NULL DEFAULT nextval(('DECLARACAO_TRANSPORTE_DISPOSICAO_FINAL_RESIDUO_SEQ'::text)::regclass),
...
CREATE SEQUENCE DECLARACAO_TRANSPORTE_ENTIDADE_TRANSPORTADORA_SEQ
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE DECLARACAO_TRANSPORTE_ENTIDADE_TRANSPORTADORA_SEQ
  OWNER TO seia_sema;
GRANT ALL ON SEQUENCE DECLARACAO_TRANSPORTE_ENTIDADE_TRANSPORTADORA_SEQ TO seia_sema;
GRANT SELECT ON SEQUENCE DECLARACAO_TRANSPORTE_ENTIDADE_TRANSPORTADORA_SEQ TO consulta;

CREATE TABLE declaracao_transporte_entidade_transportadora
(
	ide_declaracao_transporte_entidade_transportadora INTEGER NOT NULL DEFAULT nextval(('DECLARACAO_TRANSPORTE_ENTIDADE_TRANSPORTADORA_SEQ'::text)::regclass),
...
CREATE SEQUENCE DECLARACAO_TRANSPORTE_RESIDUO_SEQ
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE DECLARACAO_TRANSPORTE_RESIDUO_SEQ
  OWNER TO seia_sema;
GRANT ALL ON SEQUENCE DECLARACAO_TRANSPORTE_RESIDUO_SEQ TO seia_sema;
GRANT SELECT ON SEQUENCE DECLARACAO_TRANSPORTE_RESIDUO_SEQ TO consulta;

CREATE TABLE declaracao_transporte_residuo
(
	ide_declaracao_transporte INTEGER NULL,
	ide_declaracao_transporte_residuo INTEGER NOT NULL DEFAULT nextval(('DECLARACAO_TRANSPORTE_RESIDUO_SEQ'::text)::regclass),
...
CREATE SEQUENCE DECLARACAO_TRANSPORTE_ROTEIRO_SEQ
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE DECLARACAO_TRANSPORTE_ROTEIRO_SEQ
  OWNER TO seia_sema;
GRANT ALL ON SEQUENCE DECLARACAO_TRANSPORTE_ROTEIRO_SEQ TO seia_sema;
GRANT SELECT ON SEQUENCE DECLARACAO_TRANSPORTE_ROTEIRO_SEQ TO consulta;

CREATE TABLE declaracao_transporte_roteiro
(
	ide_declaracao_transporte_roteiro INTEGER NOT NULL DEFAULT nextval(('DECLARACAO_TRANSPORTE_ROTEIRO_SEQ'::text)::regclass),
	ide_declaracao_transporte INTEGER NULL,
...
CREATE SEQUENCE DECLARACAO_TRANSPORTE_RESIDUO_ENDERECO_SEQ
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE DECLARACAO_TRANSPORTE_RESIDUO_ENDERECO_SEQ
  OWNER TO seia_sema;
GRANT ALL ON SEQUENCE DECLARACAO_TRANSPORTE_RESIDUO_ENDERECO_SEQ TO seia_sema;
GRANT SELECT ON SEQUENCE DECLARACAO_TRANSPORTE_RESIDUO_ENDERECO_SEQ TO consulta;

CREATE TABLE declaracao_transporte_residuo_endereco
(
	ide_declaracao_transporte_residuo_endereco INTEGER NOT NULL DEFAULT nextval(('DECLARACAO_TRANSPORTE_RESIDUO_ENDERECO_SEQ'::text)::regclass),
	ide_declaracao_transporte INTEGER NULL,
...
--#9330
CREATE SEQUENCE tipo_certificado_cefir_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 999999
  START 1
...
CREATE SEQUENCE tipo_certificado_tc_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 999999
  START 1
  CACHE 1;
ALTER TABLE tipo_certificado_tc_seq
  OWNER TO seia_sema;

CREATE SEQUENCE tipo_certificado_avbndes_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 999999
  START 1
  CACHE 1;
ALTER TABLE tipo_certificado_avbndes_seq
  OWNER TO seia_sema;
  
SELECT setval('tipo_certificado_cefir_seq', 
(SELECT cast(max(substring(c1.num_certificado, 10, 6)) AS integer)
FROM certificado c1 
WHERE c1.num_certificado IS NOT null AND c1.num_certificado LIKE '%/CEFIR'
AND substring(c1.num_certificado, 0, 5) = to_char(now(),'YYYY')));

SELECT setval('tipo_certificado_tc_seq', 
(SELECT cast(max(substring(c2.num_certificado, 10, 6)) AS integer)
FROM certificado c2 
WHERE c2.num_certificado IS NOT null AND c2.num_certificado LIKE '%/TC'
AND substring(c2.num_certificado, 0, 5) = to_char(now(),'YYYY')));

SELECT setval('tipo_certificado_avbndes_seq', 
(SELECT cast(max(substring(c3.num_certificado, 10, 6)) AS integer)
FROM certificado c3 
WHERE c3.num_certificado IS NOT NULL AND c3.num_certificado LIKE '%/AVBNDES'
AND substring(c3.num_certificado, 0, 5) = to_char(now(),'YYYY')));
