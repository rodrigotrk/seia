...
SET
	...
	dtc_finalizacao = (SELECT dtc_movimentacao FROM tramitacao_requerimento WHERE ide_requerimento = 1099232 ORDER BY dtc_movimentacao DESC LIMIT 1)
WHERE
	ide_requerimento = 1099232;
