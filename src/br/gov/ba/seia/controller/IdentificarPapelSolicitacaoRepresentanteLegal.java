...
public class IdentificarPapelSolicitacaoRepresentanteLegal implements PessoaSolicitacao {
	...
	public void load(SolicitacaoDTO solicitacao) {
		...
		solicitacao.getRequerente().setPessoaJuridica(new PessoaJuridica());
	...
	public boolean isPossuiRequerente() {
		return (solicitacao.getRequerente() == null);
	}
