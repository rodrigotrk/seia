	...
	public List<Logradouro> filtrarLogradouroByNome(Bairro bairro, Integer numCep)  {
		DetachedCriteria criteria = DetachedCriteria.forClass(Logradouro.class)
		    ...
		    .add(Restrictions.and(
				...
				Restrictions.sqlRestriction("rtrim(nom_bairro) ilike '" + bairro.getNomBairro().trim() +"' and estado5_.ide_estado = 5 and municipio6_.nom_municipio like '%' || sp_get_municipio_cep("+numCep+") AND this_.ind_origem_correio is true")));
