...
public class FceLocalizacaoGeograficaService {
	...
	@TransactionAttribute(TransactionAttributeType.REQUIRED)
	public void atualizartFceLocalizacaoGeograficaPerfuracaoPoco(FceLocalizacaoGeografica paramFceLocalizacaoGeograficaPerfuracaoPoco) {
		String sql = "update FceLocalizacaoGeografica flg set flg.numExpectativaCaptacao = :numExpectativaCaptacao  where flg.ideLocalizacaoGeografica = :ideLocalizacaoGeografica and flg.ideFce = :ideFce";
		Map<String,Object> parametros = new HashMap<String, Object>();
		parametros.put("ideFce", paramFceLocalizacaoGeograficaPerfuracaoPoco.getIdeFce());
		parametros.put("numExpectativaCaptacao", paramFceLocalizacaoGeograficaPerfuracaoPoco.getNumExpectativaCaptacao());		
		parametros.put("ideLocalizacaoGeografica", paramFceLocalizacaoGeograficaPerfuracaoPoco.getIdeLocalizacaoGeografica());
		
		this.fceLocalizacaoGeograficaPerfuracaoPocoIDAO.executarQuery(sql, parametros);
	}
