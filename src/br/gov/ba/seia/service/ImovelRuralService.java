...
//			lImovelRural = imovelRuralDAO.listarClasseComNativeQuery(sql, ImovelRural.class);
	...
	public Collection<Imovel> carregarImoveisByEmpreendimento(Empreendimento empreendimento) {
		...
		criteria.add(Restrictions.isNotNull("imovelR.ideImovelRural"));
	...
	public List<ImovelRural> listarImovelRuralByProprietarioEmpreendimento(Pessoa proprietario) {
		return imovelRuralImplDao.listarImovelRuralByProprietarioEmpreendimento(proprietario);
	...
	public boolean precisaDeLicencaAreaProdutiva(ImovelRural imovelRural) throws Exception {
		boolean precisaLicencaAp = false;
		if (!Util.isNullOuVazio(imovelRural.getIndAreaProdutiva()) && imovelRural.getIndAreaProdutiva()) { // Se ele informou area produtiva
																											// (verificar todas as areas de
																											// acordo com o anexo)
	...
	public boolean precisaDeOutorga(ImovelRural imovelRural) throws Exception {
		boolean precisaOutorga = false;
		
		List<ImovelRuralUsoAgua> colecaoImovelRuralUsoAgua = new ArrayList<ImovelRuralUsoAgua>();
		colecaoImovelRuralUsoAgua = imovelRuralUsoAguaService.obterTodosPorImovelRural(imovelRural);
		...
		if ((!Util.isNull(imovelRural.getIndSubterraneo()) && imovelRural.getIndSubterraneo())
				...
				|| (!Util.isNull(imovelRural.getIndIntervencao()) && imovelRural.getIndIntervencao())) { 
			
			if (!Util.isNullOuVazio(colecaoImovelRuralUsoAgua)) {
				for (ImovelRuralUsoAgua imovelRuralUsoAgua : colecaoImovelRuralUsoAgua) { 
					...
					if ((!Util.isNull(imovelRuralUsoAgua.getIndDispensa()) && imovelRuralUsoAgua.getIndDispensa())
							|| (!Util.isNull(imovelRuralUsoAgua.getIndProcesso())
									&& imovelRuralUsoAgua.getIndProcesso())) { 
