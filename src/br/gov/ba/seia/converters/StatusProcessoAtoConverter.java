...
public class StatusProcessoAtoConverter implements Converter  {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new StatusProcessoAto(Integer.parseInt(newValue));
		else return null;
    }
