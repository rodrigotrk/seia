...
public class ObjetivoLimpAreaConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new ObjetivoLimpezaArea(Integer.valueOf(newValue));
		else return null;
    }
