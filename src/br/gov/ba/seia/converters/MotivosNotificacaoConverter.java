...
public class MotivosNotificacaoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new MotivoNotificacao(Integer.valueOf(newValue));
		else return null;
    }
