...
public class TipoLocalAtividadeInexigivelConverter implements Converter  {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && (SELECIONE.equals(newValue) || TODOS.equals(newValue))) {
			...
			return new TipoLocalAtividadeInexigivel(Integer.parseInt(newValue));
		}
		else return null;
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
		...
		if (!Util.isNullOuVazio(value)) return String.valueOf(value.toString());
		else return null;
    }
}