...
public class ProcuradorPessoaFisicaConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new ProcuradorPessoaFisica(Integer.parseInt(newValue));
		else return null;
    }
