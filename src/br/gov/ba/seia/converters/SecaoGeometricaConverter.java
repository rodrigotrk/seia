...
public class SecaoGeometricaConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new ClassificacaoSecaoGeometrica(Integer.valueOf(newValue));
		else return null;
    }
