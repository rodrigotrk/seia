...
public class TipoRecuperacaoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new TipoRecuperacao(Integer.valueOf(newValue));
		else return null;
    }
