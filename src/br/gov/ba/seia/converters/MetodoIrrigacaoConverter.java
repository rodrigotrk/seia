...
public class MetodoIrrigacaoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new MetodoIrrigacao(Integer.valueOf(newValue));
		else return null;
    }
