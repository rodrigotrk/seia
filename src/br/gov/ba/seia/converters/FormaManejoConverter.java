...
public class FormaManejoConverter implements Converter  {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
		...
		if (!Util.isNullOuVazio(newValue) && !SELECIONE.equals(newValue)) return new  FormaManejo(Integer.valueOf(newValue));
		else return null;
    }
