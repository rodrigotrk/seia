 ...
 */
public class VegetacaoNativaListener {
    @PostLoad
    public void loadFinalidades(VegetacaoNativa vegetacaoNativa) {
        Hibernate.initialize(vegetacaoNativa.getVegetacaoNativaFinalidadeCollection());
    }
}